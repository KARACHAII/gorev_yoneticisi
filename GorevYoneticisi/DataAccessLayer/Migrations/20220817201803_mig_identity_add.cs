        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanCreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PlanDay = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PlanStatus = table.Column<bool>(type: "bit", nullable: false),
                    UserID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Plandb", x => x.PlanID);
                    table.ForeignKey(
                        name: "FK_Plandb_Userdb_UserID",
                        column: x => x.UserID,
